...
{
  //Crate local storage with empty array JSON.stringify using save data to localstorage as object array
  localStorage.setItem('todolist',JSON.stringify(mainList));
}
else
{
  //pull data drom localstorage JSON.parse using pull object data from localstorage to local variable
